...
2. Reviewer gates: no milestone "done" without reviewer approval
3. PM updates this file every cycle
4. Agents update GAP_ANALYSIS.md checkboxes when items complete
